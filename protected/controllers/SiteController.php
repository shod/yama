...
class SiteController extends Controller {
	...
	public $description = 'Подать объявление на доске частных объявлений бесплатно. Барахолка - бесплатные объявления.';
	public $keywords = 'бесплатные объявления подать доска частные отдам даром сайт дать подать купить куплю бу недорого минск беларусь‏';
